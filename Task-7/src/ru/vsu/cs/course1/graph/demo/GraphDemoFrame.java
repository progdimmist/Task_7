...
import ru.vsu.cs.course1.graph.myTask;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel4.setBorder(BorderFactory.createTitledBorder(null, "До какой точки делать путь", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        final JLabel label1 = new JLabel();
        label1.setText("Вершина B: ");
        ...
        buttonDfsQueue.setText("Task");
        panel6.add(buttonDfsQueue, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JScrollPane scrollPane3 = new JScrollPane();
        panel1.add(scrollPane3, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        tableInput = new JTable();
        scrollPane3.setViewportView(tableInput);
        final JLabel label2 = new JLabel();
        label2.setText("Какие точки надо обойти");
    ...
    public GraphDemoFrame() {
        ...
        buttonDfsQueue.addActionListener(e -> {
            try {
                ...
                showSystemOut(() -> {
                    int from = 0;
                    int to = (int) spinnerFromVertex.getValue();

                    LinkedList<Integer> arr = myTask.task(graph, from, to, array);
